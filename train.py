...
def export_mesh(args):
    ...
    convert_sdf_samples_to_ply(alpha.cpu(), f'{args.ckpt[:-3]}.ply',bbox=tensorf.aabb.cpu(), level=0.0005)
...
def reconstruction(args):
    ...
    if args.ckpt is not None:
        ...
        tensorf = eval(args.model_name)(aabb, reso_cur, device,
                    density_n_comp=n_lamb_sigma, appearance_n_comp=n_lamb_sh, app_dim=args.data_dim_color, sigma_dim=args.data_dim_sigma, near_far=near_far,
    ...
    Eikonal_loss_weight = args.Eikonal_loss_weight
