...
def OctreeRender_trilinear_fast(rays, tensorf, chunk=4096, N_samples=-1, ndc_ray=False, white_bg=True, device='cuda', is_train=True):

    rgbs, alphas, depth_maps, normal_maps, weights, uncertainties = [], [], [], [], [], []
    orient_losses = []
    eikonal_loss = []
    ...
    return torch.cat(rgbs), None, torch.cat(depth_maps), None, None, torch.cat(normal_maps), orient_losses, eikonal_loss
